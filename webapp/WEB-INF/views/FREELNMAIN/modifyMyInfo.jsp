...
<!-- <script>
$(function(){
	var arr_major_tech = new Array();
	
	<c:forEach items="${arr_major_tech}" var="arr_major_tech">
		var json = new Object();
		json.majorTech = "${arr_major_tech}";
		arr_major_tech.push(json);
		console.log(arr_major_tech.majorTech);
	</c:forEach>
	
	/* console.log(arr_major_tech[0],indexOf(':')); */
						...
						<div class="col-md-6">
							<div class="form-label-group">
								<input type="password" id="confirmPwd" class="form-control"
								 value="${freeln.freeln_pwd}" required="required">
...
<div class="form-group">
	<div class="form-row">
	 <c:forEach var="freelancerCareer" items="${freelancerCareer}">
		<div class="col-md-6">
			<div class="form-label-group">
				<input type="text" id="client_nm" name="client_nm" class="form-control" 
				value="${freelancerCareer.client_nm}" required="required" autofocus="autofocus">
				<label for="client_nm">Client Name</label>
			</div>
		</div>
		 <div class="col-md-3">
			<div class="form-label-group">
				<input type="text" id="cli_loca_1" name="client_local_1" class="form-control" 
				value="${freelancerCareer.client_loca_1}" autofocus="autofocus">
				<label for="cli_loca_1">광역시,도</label>
			</div>
		</div>
		 <div class="col-md-3">
			<div class="form-label-group">
				<input type="text" id="cli_loca_2" name="client_local_2" class="form-control" 
				value="${freelancerCareer.client_loca_2}"  autofocus="autofocus">
		...
		<div class="col-md-6">
			<div class="form-label-group">
				...
				value="${freelancerCareer.duty}" required="required">
		...
		<div class="col-md-6">
			<div class="form-label-group">
				...
				value="${freelancerCareer.task}" required="required">
		...
		<div class="col-md-6">
			<div class="form-label-group"> 
				<input type="text" id="work_str_date" name="work_str_date" class="form-control" 
				value="${freelancerCareer.work_str_date}" required="required"/>              
		...
		<div class="col-md-6">
			<div class="form-label-group"> 
				<input type="text" id="work_end_date" name="work_end_date" class="form-control" 
				value="${freelancerCareer.work_end_date}" required="required"/>
		...
		<div class="col-md-12">
			<div class="form-label-group"> 
				...
				value="${freelancerCareer.contents}" required="required"></textarea>
		...
		<div class="col-md-6">
			<div class="form-label-group"> 
				<input type="text" id="use_tech_1" name="use_tech_1" class="form-control" 
				value="${freelancerCareer.use_tech_1}"/>
		...
		<div class="col-md-6">
			<div class="form-label-group"> 
				<input type="text" id="use_tech_2" name="use_tech_2" class="form-control" 
				value="${freelancerCareer.use_tech_2}"/>
		...
		<div class="col-md-12">
			<div class="form-label-group"> 
				<input type="text" id="work_money" name="work_money" class="form-control" 
				value="${freelancerCareer.work_money}"/>
